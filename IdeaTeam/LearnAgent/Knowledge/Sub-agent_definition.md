# Sub-agent: LearnAgent (Knowledge Web Scraping & Research)

## 1. Vai trò & Trách nhiệm
`LearnAgent` là một sub-agent chuyên biệt thuộc **Agent 1 (Idea Intake)**. Nhiệm vụ chính là "học" và trích xuất các ý tưởng sản phẩm, tính năng, và giá trị cốt lõi từ các website có sẵn (đối thủ cạnh tranh, sản phẩm tương tự, hoặc nguồn cảm hứng).
